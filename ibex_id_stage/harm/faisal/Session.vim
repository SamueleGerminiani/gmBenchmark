...
silent only
silent tabonly
cd ~/BM/gmTB/ibex_id_stage/harm/faisal
...
tabnew
tabrewind
edit src/ibex_id_stage.v
argglobal
balt src/ibex_id_stage.v
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let &fdl = &fdl
let s:l = 248 - ((21 * winheight(0) + 13) / 27)
...
normal! 068|
tabnext
edit OLDFibex_id_stage.v
argglobal
balt OLDFibex_id_stage.v
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
tabnext 1
set stal=1
badd +0 src/ibex_id_stage.v
badd +0 OLDFibex_id_stage.v
