...
tabnew
tabrewind
edit harm/faisal/conf.xml
argglobal
balt harm/faisal/conf.xml
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
normal! 022|
tabnext
edit harm/faisal/src/ibex_controller.v
argglobal
balt harm/faisal/src/ibex_controller.v
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let &fdl = &fdl
let s:l = 206 - ((16 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 206
...
tabnext 1
set stal=1
badd +15 harm/faisal/conf.xml
badd +100 harm/faisal/src/ibex_controller_bench.v
badd +0 harm/faisal/src/ibex_controller.v
badd +2 ~/gmTB/ibex_compressed_decoder/harm/faisal/src/ibex_compressed_decoder.v
