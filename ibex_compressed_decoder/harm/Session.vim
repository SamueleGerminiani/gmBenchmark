...
silent only
silent tabonly
cd ~/gmTB/ibex_compressed_decoder/harm
...
tabnew
tabrewind
edit faisal/conf.xml
argglobal
balt faisal/conf.xml
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
normal! 022|
tabnext
edit faisal/faisal.v
argglobal
balt faisal/faisal.v
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let &fdl = &fdl
let s:l = 147 - ((24 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 147
normal! 017|
tabnext
edit faisal/src/ibex_compressed_decoder_bench.v
argglobal
balt faisal/src/ibex_compressed_decoder_bench.v
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
normal! 014|
tabnext
edit faisal/src/ibex_compressed_decoder.v
argglobal
balt faisal/src/ibex_compressed_decoder.v
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 103 - ((28 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 103
...
tabnext 1
set stal=1
badd +15 faisal/conf.xml
badd +0 ~/gmTB/ibex_compressed_decoder/gm/ibex_compressed_decoder_bench.v
badd +15 ~/simple_platform/questa.simulation/faisal/conf.xml
badd +1 faisal/src/ibex_compressed_decoder_bench.v
badd +328 faisal/src/ibex_compressed_decoder_preprocessed_code.v
badd +1 faisal/src/ibex_compressed_decoder.v
badd +0 faisal/faisal.v
badd +13 ~/simple_platform/questa.simulation/faisal/faisal.v
badd +29 ~/simple_platform/simple_platform.srcs/sources_1/new/buslayer_master.sv
